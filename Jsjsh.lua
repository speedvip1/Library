...
do local GUI = game.CoreGui:FindFirstChild("Base64 Hub");if GUI then GUI:Destroy();end;if _G.Color == nil then
       _G.Color = Color3.fromRGB(102, 0, 204)
   end 
end
...
function Base64Hub:ToggleUi()
if game.CoreGui:FindFirstChild("Base64Hub").Enabled == true then -- oh am dumb
game.CoreGui:FindFirstChild("Base64Hub").Enabled = false
else
game.CoreGui:FindFirstChild("Base64Hub").Enabled = true
end
end

function Base64Hub:Window(text,gamenme,logo,keybind)
    local hubname = text
	...
	local Base64Hub = Instance.new("ScreenGui") -- guess i am using hubname wrong
	Base64Hub.Name = "Base64 Hub" -- wait
	Base64Hub.Parent = game.CoreGui
	Base64Hub.ZIndexBehavior = Enum.ZIndexBehavior.Sibling

	local Main = Instance.new("Frame")
	Main.Name = "Main"
	Main.Parent = Base64Hub
	...
	Main:TweenSize(UDim2.new(0, 656, 0, 340),"Out","Quad",0.4,true)
