local Configs_HUB = {
  ...
  Cor_Stroke = Color3.fromRGB(102, 0, 204),
...
function MakeWindow(Configs)
  ...
  function AddVideoLabel(parent, Configs)
    local LabelName = Configs.Name or ""
    local VideoId = Configs.Video or ""
    local VideoUrl = Configs.Url or ""
    ...
    local ImageLabel = Create("ImageLabel", Frame, {
        Image = VideoId ~= "" and VideoId or "rbxassetid://",
        Size = UDim2.new(0, 75, 0, 75),
        Position = UDim2.new(0, 10, 0, 25)
    })
    
    local PlayIcon = Create("ImageLabel", ImageLabel, {
        Image = "rbxassetid://", 
        Size = UDim2.new(0, 30, 0, 30),
