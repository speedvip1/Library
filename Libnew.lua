...
function Kavo.CreateLib(kavName, themeList)
    ...
    -- ============================================
    -- Configure Disabled Toggle Icon
    -- ============================================
    ...
    -- ============================================
    -- Configure Ripple Effect Sample
    -- ============================================
    Sample.Name = "Sample"
    ...
    btn.MouseButton1Click:Connect(function()
        if not focusing then
            ...
            local rippleEffect = createRippleEffect(btn, sample, ms)
    ...
    -- ============================================
    local function createRippleEffect(button, sampleImage, mouse)
        local c = sampleImage:Clone()
        c.Parent = button
