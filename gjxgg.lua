...
function MakeWindow(Configs)
  ...
  function MakeTab(Configs)
    ...
    local PremiumOnly = Configs.PremiumOnly or false
    local LockImageId = Configs.LockImageId or "rbxassetid://99761391181847"
    ...
    local LockImage
    if PremiumOnly then
        LockImage = Create("ImageLabel", Frame, {
    ...
    TextButton.MouseButton1Click:Connect(function()
        ...
        if PremiumOnly and player.MembershipType == Enum.MembershipType.None then
            local Notification = Create("TextLabel", ScrollBar.Parent, {
                Size = UDim2.new(0, 200, 0, 40),
                Position = UDim2.new(0.5, -100, 0.5, -20),
                BackgroundColor3 = Color3.fromRGB(255, 50, 50),
                Text = "This tab is for Premium users only!",
...
function AddDiscord(parent, Configs)
    ...
    local LuckText = Configs[4] or Configs.LuckText or "Join server key changes every month" 
    ...
    local PlayerStatsLabel = Create("TextLabel", Frame, {
        Size = UDim2.new(1, -60, 0, 25),
        Text = "Players in Server: " .. #game:GetService("Players"):GetPlayers(),
        TextXAlignment = "Left",
        BackgroundTransparency = 1,
